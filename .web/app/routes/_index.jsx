...
function Div_2628ad2a3daf5e014fa1549f44d37d54 () {
  const reflex___state____state__sc2_map_forge___states___generation_state____generation_state = useContext(StateContexts.reflex___state____state__sc2_map_forge___states___generation_state____generation_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
...
function Div_0f574bfd5d9f4dd5ee842463d3b7c5e2 () {
  const reflex___state____state__sc2_map_forge___states___generation_state____generation_state = useContext(StateContexts.reflex___state____state__sc2_map_forge___states___generation_state____generation_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
...
function Div_af9456ad8672def563076accd9335e80 () {
  const reflex___state____state__sc2_map_forge___states___generation_state____generation_state = useContext(StateContexts.reflex___state____state__sc2_map_forge___states___generation_state____generation_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
...
function Div_54492cb16aa69b6e4dbf028445d069f6 () {
  const reflex___state____state__sc2_map_forge___states___generation_state____generation_state = useContext(StateContexts.reflex___state____state__sc2_map_forge___states___generation_state____generation_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
...
function Div_389faaefc2ebd7d09abbb99958ee87db () {
  
                useEffect(() => {
                    ((...args) => (addEvents([(ReflexEvent("reflex___state____state.sc2_map_forge___states___generation_state____generation_state.on_load", ({  }), ({  })))], args, ({  }))))()
                    return () => {
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx(Div_389faaefc2ebd7d09abbb99958ee87db,{},),jsx("title",{},"SMAC-AST \u00b7 \u751f\u6210\u5730\u56fe"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}